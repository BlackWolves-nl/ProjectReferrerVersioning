...
namespace WolvePack.VS.Extensions.ProjectReferrerVersioning.Commands
{
    internal sealed class ShowReferrerChainWindowCommand
    {
        ...
        public static readonly Guid CommandSet = new Guid("84B4ECA1-1947-43B4-8B75-BA68C8216341");
        ...
        private ShowReferrerChainWindowCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
            ...
            CommandID menuCommandIDSingle = new CommandID(CommandSet, CommandIdSingle);
            ...
            // Extension menu item
            CommandID menuCommandIDExtension = new CommandID(CommandSet, CommandIdExtension);
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            if(selectedProjects.Count > 0)
            {
                ...
                UI.MainWindow window = new UI.MainWindow(selectedProjects);
                window.Show();
            }
        }
        ...
        private void ExecuteExtensionMenu(object sender, EventArgs e)
        {
            ...
            if (!(Package.GetGlobalService(typeof(DTE)) is DTE2))
                return;
